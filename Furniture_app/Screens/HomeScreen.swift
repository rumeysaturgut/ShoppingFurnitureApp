...
//  Furniture_app
//
//  Created by Rumeysa Turgut on 15.02.2023.
//
...
struct HomeScreen: View {
    ...
    //            Custom Bottom NavBar
                ...
                HStack {
                    ...
                    BottomNavBarItem(image: Image(uiImage: UIImage(imageLiteralResourceName: "fav"))) {}
                    BottomNavBarItem(image: Image(uiImage: UIImage(imageLiteralResourceName: "shop"))) {}
...
struct SearchAndScanView: View {
    ...
    var body: some View {
        HStack {
            ...
            Button(action: {}) {
                Image(uiImage: UIImage(imageLiteralResourceName: "Scan"))
                    .resizable()
